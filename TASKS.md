...
```
| # | Task description | Owner | AI used | `todo` | YYYY-MM-DD | Notes |
```

Increment # from the last row. Assign clearly — one owner per task. If no AI is involved, leave AI column as `—`.
